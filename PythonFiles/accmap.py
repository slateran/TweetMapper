...
def acc(): #initialise all functions in this script from the menu
    printTweet()
    mapit.save('acc.html')#save the map and points
    webbrowser.open_new_tab('acc.html')#launch the map in default web browser in a new tab when finished
