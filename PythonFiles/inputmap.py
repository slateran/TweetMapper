...
def inp(): #initialise all functions in this script from the menu
    printTweet()
    mapit.save('input.html')#save the map and points
    webbrowser.open_new_tab('input.html')#launch the map in default web browser in a new tab when finished
