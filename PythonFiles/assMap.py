...
def amap(): #initialise all functions in this script from the menu
    printTweet()
    mapit.save('assmap.html')#save the map and points
    webbrowser.open_new_tab('assmap.html')#launch the map in default web browser in a new tab when finished
