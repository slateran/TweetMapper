...
def printTweet(): #this will print the latest tweets in the database along with the username and location
...
def tmap(): #initialise all functions in this script from the menu
    printTweet()
    mapit.save('theftmap.html')#save the map and points
    webbrowser.open_new_tab('theftmap.html')#launch the map in default web browser in a new tab when finished
